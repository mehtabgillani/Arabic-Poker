...
const AccountForm = ({ handleSubmit }) => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      <NavLink className="btn btn-primary account__btn" to="/app_dashboard">Unlock</NavLink>
      <NavLink className="btn btn-outline-danger account__btn" to="/app_dashboard">Logout</NavLink>
    </form>
  );
};
